...
def lsf_sigma(λ: float, R_inv: float):
    """
    ...
    :param Ri: [optional]
        The input spectral resolution (default: infinity).
...
def lsf_sigma_and_bounds(
    λo: float, 
    R_inv: float, 
    σ_window: Union[float, int] = 5
):
    """
...
def _instrument_lsf_kernel(
    ...
    **kwargs
    ...
    """
    σ, lower, upper = lsf_sigma_and_bounds(λo, R_inv, **kwargs)
